...
export default async function EvaniaPage() {
  ...
  const diagnosticos = [
    ...
    { label: "Itens sem valor (a cotar)", n: agenda.itensSemValor, href: "/admin/cotacoes", cor: "text-warn" },
    { label: "Com valor, sem parcelas", n: agenda.comValorSemParcela, href: "/admin/parcelas", cor: "text-warn" },
