...
export async function CotacoesTab() {
  ...
  return (
    <>
      {!isSupabaseConfigured ? (
        ...
        <Notice>
          Os itens vêm da aba <strong>Orçamento</strong> (e de Lançamentos). Registre propostas de fornecedores por
          item e compare lado a lado. Ao <strong>escolher</strong> uma proposta, o item vira{" "}
          <strong>contratado</strong> com o valor da proposta e já aparece em <strong>Lançamentos</strong>, onde
          você define a condição de pagamento (datas de cada parcela). As demais propostas ficam como recusadas,
