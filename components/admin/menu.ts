...
export const ADMIN_MENU: MenuEntry[] = [
  ...
  { section: "Comunicação" },
  { label: "Visão geral", ico: "megaphone", href: "/admin/comunicacao" },
  { label: "Operação da Evania", ico: "heart", href: "/admin/comunicacao/evania" },
  { label: "Calendário", ico: "calendar", href: "/admin/comunicacao/calendario" },
  { label: "Jornadas", ico: "compass", href: "/admin/comunicacao/jornadas" },
  { label: "Perfis de comunicação", ico: "puzzle", href: "/admin/comunicacao/perfis" },
  { label: "Campanhas", ico: "megaphone", href: "/admin/comunicacao/campanhas" },
  { label: "Mensagens", ico: "mail", href: "/admin/comunicacao/mensagens" },
  { label: "Áudios", ico: "mic", href: "/admin/comunicacao/audios" },
  { label: "Caixa de entrada", ico: "inbox", href: "/admin/comunicacao/caixa-de-entrada" },
  { label: "Respostas rápidas", ico: "bolt", href: "/admin/comunicacao/respostas-rapidas" },
  { label: "Estúdio de prompts", ico: "sparkles", href: "/admin/comunicacao/prompts" },
  { label: "Aprovações", ico: "check-badge", href: "/admin/comunicacao/aprovacoes" },
  { label: "Relatórios", ico: "chart", href: "/admin/comunicacao/relatorios" },
  { label: "WhatsApp oficial", ico: "phone", href: "/admin/configuracoes/comunicacao/whatsapp" },

  { section: "Padrinhos & madrinhas" },
  { label: "Visão geral", ico: "rings", href: "/admin/padrinhos" },
  { label: "Duplas e casais", ico: "heart", href: "/admin/padrinhos/duplas" },
  { label: "Grupos", ico: "users", href: "/admin/padrinhos/grupos" },
  { label: "Compromissos", ico: "pin", href: "/admin/padrinhos/compromissos" },
  { label: "Trajes e medidas", ico: "suit", href: "/admin/padrinhos/trajes" },
  { label: "Pendências", ico: "alert", href: "/admin/padrinhos/pendencias" },
  { label: "Tarefas", ico: "tasks", href: "/admin/padrinhos/tarefas" },
  ...
  { label: "Parcelas", ico: "layers", href: "/admin/parcelas" },
  { label: "Projeção mensal", ico: "trend", href: "/admin/projecao" },
