...
export const ADMIN_MENU: MenuEntry[] = [
  ...
  { section: "Comunicação" },
  { label: "Visão geral", ico: "📣", href: "/admin/comunicacao" },
  ...
  { label: "Caixa de entrada", ico: "📥", href: "/admin/comunicacao/caixa-de-entrada" },
  { label: "Respostas rápidas", ico: "⚡", href: "/admin/comunicacao/respostas-rapidas" },
  { label: "Estúdio de prompts", ico: "🪄", href: "/admin/comunicacao/prompts" },
  { label: "Aprovações", ico: "✅", href: "/admin/comunicacao/aprovacoes" },
  { label: "Relatórios", ico: "📊", href: "/admin/comunicacao/relatorios" },
  { label: "WhatsApp oficial", ico: "🟢", href: "/admin/configuracoes/comunicacao/whatsapp" },
  { section: "Padrinhos & madrinhas" },
  { label: "Visão geral", ico: "👰", href: "/admin/padrinhos" },
  { label: "Duplas e casais", ico: "💞", href: "/admin/padrinhos/duplas" },
  { label: "Grupos", ico: "👥", href: "/admin/padrinhos/grupos" },
  { label: "Compromissos", ico: "📌", href: "/admin/padrinhos/compromissos" },
  { label: "Trajes e medidas", ico: "🤵", href: "/admin/padrinhos/trajes" },
  { label: "Pendências", ico: "⚠️", href: "/admin/padrinhos/pendencias" },
  { label: "Tarefas", ico: "🗒️", href: "/admin/padrinhos/tarefas" },
  { section: "Presentes" },
