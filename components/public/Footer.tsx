...
export function Footer({ noiva, noivo, dataExtenso }: { noiva: string; noivo: string; dataExtenso: string }) {
  return (
    <footer className="bg-bronze-deep px-6 py-16 text-center text-cream">
      ...
      <Link
        href="/admin"
        className="mt-6 inline-block text-xs uppercase tracking-[0.2em] text-champagne opacity-60 transition hover:opacity-100"
      >
        Painel dos noivos
      </Link>
    </footer>
